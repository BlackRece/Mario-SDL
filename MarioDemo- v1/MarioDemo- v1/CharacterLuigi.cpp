...
CharacterLuigi::CharacterLuigi(SDL_Renderer* renderer,
...
void CharacterLuigi::Respawn(Vector2D startPos) {
	...
	switch (e.type) {
		case SDL_KEYDOWN:
			...
			switch (e.key.keysym.sym) {
				...
				case SDLK_DOWN: mIsShooting = true; break;
			}
		break;
		...
		case SDL_KEYUP:
			...
			switch (e.key.keysym.sym) {
				...
				case SDLK_DOWN:		mIsShooting = false; break;
			}
		break;
	}
