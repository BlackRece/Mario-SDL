...
bool Texture2D::LoadFromFile(std::string path, int cRed, int cGreen, int cBlue) {
	...
	if (pSurface == nullptr) {
		...
		SDL_SetColorKey(pSurface, SDL_TRUE, SDL_MapRGBA(pSurface->format, cRed, cGreen, cBlue, 0));
...
void Texture2D::RenderRect(SDL_Rect &srcRect, SDL_Rect &destRect, SDL_RendererFlip &flip, double angle) {
